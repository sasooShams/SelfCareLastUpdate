...
public  class DoctorRegistration extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView login=(TextView)findViewById(R.id.drbtnnext);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    //reg.delet();
                    Intent i = new Intent(DoctorRegistration.this, Login_Register.class);
                    startActivity(i);
                }
                catch (Exception E){
                    Toast.makeText(DoctorRegistration.this,E.toString(),Toast.LENGTH_SHORT).show();
    ...
    private DatePickerDialog.OnDateSetListener dpickerListener=new DatePickerDialog.OnDateSetListener(){
        ...
        public void onDateSet(DatePicker view,int year,int monthOfYear,int dayOfMonth){
            ...
            month =monthOfYear + 1;
            day =dayOfMonth;
            Toast.makeText(DoctorRegistration.this,year +"/"+ month +"/"+ day,Toast.LENGTH_SHORT).show();
        }
    };
                ...
                if (!validate()) {
                    ...
                    try {
                        ...
                        if (id>0){
                            ...
                            Intent i = new Intent(DoctorRegistration.this, DR_RelativeNumbers.class);
                            startActivity(i);
                        }
