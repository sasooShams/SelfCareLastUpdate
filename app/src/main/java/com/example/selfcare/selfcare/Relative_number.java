...
public class Relative_number extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Email  =shared.getString("Paient_email", "null");
    ...
    public void onClick(View v) {
            ...
            if (!validate()) {
                ...
                return;
                    ...
                    long id = reg.relative_insert(mob1, mob2, mob3, mob4,Email);

                    if (id > 0)
                    {
                        Toast.makeText(getBaseContext(), "sucjdjd", Toast.LENGTH_LONG).show();

                Intent i = new Intent(Relative_number.this, Patient_Taphost.class);
                startActivity(i);
